"""Connection diagnostic: whether the camera's main program answers."""
...
class ConnectionSensor(PortCheckEntity, BinarySensorEntity):
    """On while the camera accepts connections on port 443.
